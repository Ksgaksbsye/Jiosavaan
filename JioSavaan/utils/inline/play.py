...
##bar of wynk--------------------------------------
    ...
    if 0 < anon <= 5:
        bar = "𝐒aregaмa вeѕт ғeaтυreѕ"
    elif 5 <= anon < 10:
        bar = "𝐒aregaмa ғavorιтe playlιѕт"
    elif 10 <= anon < 15:
        bar = "𝐒aregaмa мιllιon ѕongѕ"
    elif 15 <= anon < 20:
        bar = "𝐒aregaмa eaѕιly ѕтreaм"
    elif 20 <= anon < 25:
        bar = "low-ѕpeed ѕтreaмιng"
    elif 25 <= anon < 30:
        bar = "𝐒aregaмa 𝐁𝗂𝗀 𝐃α𝗍αᑲα𝗌ɦ"
    elif 30 <= anon < 35:
        bar = "𝐅𝗋𝖾𝖾 𝐃ⱺω𐓣ᥣⱺαᑯ 𝐌υ𝗌𝗂𝖼"
    elif 35 <= anon < 40:
        bar = "𝐒aregaмa 𝐅α𝗏ⱺ𝗋𝗂𝗍𝖾 ρᥣα𝗒ᥣ𝗂𝗌𝗍"
    elif 40 <= anon < 45:
        bar = "𝐋α𝗀 𝐅𝗋𝖾𝖾 𝐒aregaмa"
    elif 45 <= anon < 50:
        bar = "𝐒aregaмa 𝐒𝗍υᑯ𝗂ⱺ"
    elif 50 <= anon < 55:
        bar = "𝐒aregaмa 𝐀ρρ"
    elif 55 <= anon < 60:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐒aregaмa 𝐎𐓣 𝐓𝖾ᥣ𝖾𝗀𝗋αꭑ"
    elif 60 <= anon < 65:
        bar = "𝐄𐓣𝗃ⱺ𝗒 𝐒aregaмa 𝐌υ𝗌𝗂𝖼"
    elif 65 <= anon < 70:
        bar = "𝐒aregaмa 𝑴𝒖𝒔𝒊𝒄"
    elif 70 <= anon < 75:
        bar = "𝐒aregaмa 𝐁𝖾𝗌𝗍 𝐅𝖾α𝗍υ𝗋𝖾𝗌"
    elif 80 <= anon < 80:
        bar = "𝐒aregaмa 𝐌𝗂ᥣᥣ𝗂ⱺ𐓣 𝐒ⱺ𐓣𝗀𝗌"
    elif 80 <= anon < 85:
        bar = "𝐒aregaмa 𝐄α𝗌𝗂ᥣ𝗒 𝐒𝗍𝗋𝖾αꭑ"
    elif 85 <= anon < 90:
